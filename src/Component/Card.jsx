  ...
  return (
    <div className="flex items-center justify-center mb-5">
      <div className="max-w-screen-xl w-full flex rounded-lg shadow-lg h-80" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.8)),url(${data.cover})` }}>
        <div className="h-100 w-100 p-4 flex flex-col justify-between">
          <div>
            ...
            {/*Status*/}
            <span className="absolute b-0 block text-lg leading-tight font-medium text-white overflow-hidden">Tình Trạng:
              {
